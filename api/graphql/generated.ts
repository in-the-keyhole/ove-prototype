...
import { CompanyModel, SiteModel } from "./data/types";
...
export type ResolversTypes = {
  ...
  Site: ResolverTypeWrapper<SiteModel>;
...
> = {
  createCompany?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateCompanyArgs, "name">
  >;
};
...
> = {
  ...
  sites?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerySitesArgs, "companyId">
  >;
};
